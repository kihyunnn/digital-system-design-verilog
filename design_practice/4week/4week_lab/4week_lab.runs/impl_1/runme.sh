...
HD_PWD='E:/Dev/dev-git/digital-system-design-verilog/design_practice/4week/4week_lab/4week_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comp_4_c1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comp_4_c1.tcl -notrace
