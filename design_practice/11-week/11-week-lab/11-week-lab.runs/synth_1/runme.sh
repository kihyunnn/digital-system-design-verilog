...
HD_PWD='E:/Dev/sync-git/digital-system-design-verilog/design_practice/11-week/11-week-lab/11-week-lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source lfsr_top.tcl
