...
HD_PWD='E:/Dev/sync-git/digital-system-design-verilog/design_practice/11-week/11-week-lab/11-week-lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log lfsr_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source lfsr_top.tcl -notrace
