...
HD_PWD='E:/Dev/sync-git/digital_system_design/design_practice/3week/3week_lab/3week_lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ha_1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ha_1.tcl -notrace
