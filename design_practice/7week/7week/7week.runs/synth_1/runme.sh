...
HD_PWD='E:/Dev/dev-git/digital-system-design-verilog/design_practice/7week/7week/7week.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log seq_detector.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source seq_detector.tcl
