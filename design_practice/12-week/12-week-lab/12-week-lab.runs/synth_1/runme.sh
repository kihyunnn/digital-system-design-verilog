...
HD_PWD='E:/Dev/sync-git/digital-system-design-verilog/design_practice/12-week/12-week-lab/12-week-lab.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_gen_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pattern_gen_top.tcl
