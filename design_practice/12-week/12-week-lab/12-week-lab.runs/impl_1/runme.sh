...
HD_PWD='E:/Dev/sync-git/digital-system-design-verilog/design_practice/12-week/12-week-lab/12-week-lab.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log pattern_gen_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source pattern_gen_top.tcl -notrace
