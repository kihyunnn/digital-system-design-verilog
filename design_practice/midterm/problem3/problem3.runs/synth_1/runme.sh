...
HD_PWD='E:/Dev/dev-git/digital-system-design-verilog/design_practice/midterm/problem3/problem3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log booth_mul_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source booth_mul_top.tcl
