...
set rc [catch {
  ...
  open_checkpoint E:/Dev/dev-git/digital-system-design-verilog/design_practice/midterm/problem2/problem2.runs/impl_1/fir_filter.dcp
...
set rc [catch {
  ...
  phys_opt_design 
  write_checkpoint -force fir_filter_physopt.dcp
